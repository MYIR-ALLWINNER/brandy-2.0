...
prepare_toolchain()
{
	...
	#local toolchain_archive_arm="./tools/toolchain/gcc-linaro-7.3.1-2018.05-x86_64_arm-linux-gnueabihf.tar.xz";
	#local tooldir_arm="./tools/toolchain/gcc-linaro-7.3.1-2018.05-x86_64_arm-linux-gnueabihf";
...
function build_spl-pub_once()
{
	...
	mode=$2
	path=$3
	echo "--------build for mode:${mode} board:${board}-----path:${path}-----CP:${CP}--------"
	(
	cd ${path}
